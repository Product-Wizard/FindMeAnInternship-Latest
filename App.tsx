...
const JobBoard = () => {
  const jobs: Job[] = [
    ...
    { id: '3', title: 'Data Analysis Trainee', company: 'FinCorp', location: 'Chicago, IL', type: 'On-site', category: 'Finance', postedDate: '3 days ago', description: 'Learn SQL and Tableau with our senior team.' },
    { id: '4', title: 'Community Outreach', company: 'City Food Bank', location: 'San Francisco, CA', type: 'On-site', category: 'Non-Profit', postedDate: 'Just now', description: 'Help organize local food drives.' },
    { id: '5', title: 'Graphic Design Intern', company: 'CreativeStudio', location: 'Remote', type: 'Remote', category: 'Design', postedDate: '1 week ago', description: 'Create assets for client campaigns.' },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-brand-dark">Current Opportunities</h2>
          <p className="text-slate-600">Find the perfect role to kickstart your career.</p>
        </div>
